<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a
                        href="{{ Auth::user()->role === 'siswa' ? route('siswa.dashboard') : route('admin.dashboard') }}">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @else
                        ...
                        <x-nav-link :href="route('siswa.laporan.index')" :active="request()->routeIs('siswa.laporan.*')">
                            {{ __('Riwayat Siswa Lain') }}
                        </x-nav-link>
                    @endif
                </div>
            </div>
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            @php
                $dashboardRoute = Auth::user()->role === 'siswa' ? 'siswa.dashboard' : 'admin.dashboard';
            @endphp
